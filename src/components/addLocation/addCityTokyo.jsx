...
export default props => {
    ...
    return (
        <View style={estilo.Views}>
            ...
            <Pressable style={style.ButtonLocation} onPress={() => props.navigation.navigate('PointTokyo')}>
                <Text style={style.ButtonText}>Location Name</Text>
            </Pressable>
            <Pressable style={style.ButtonLocation} onPress={() => props.navigation.navigate('PointTokyo')}>
                <Text style={style.ButtonText}>Location Info</Text>
            </Pressable>
            <Pressable style={style.ButtonAdd} onPress={() => props.navigation.navigate('PointTokyo')}>
